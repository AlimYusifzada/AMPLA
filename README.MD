...
Once **files** or a**directories** button is pressed you will be asked to select source code you wish to compare. XLS files will be generated in the 'after' directory.
