...
## V0.9.1 Mar-12,2021 add dbinst and bax classes
...
class block:
        ...
        def __init__(self,address='',name='',extra=''):
                ...
                Name: logic block name like MOVE,OR,AND,..\n \
                    in case of DB element used to keep instance type.\n \
                Adress (unique): logic block address like PC12.1.1.2\n \
                    in case of DB element used to keep instance name.\n \
                Extra: the logic block parameters MOVE(B,16)\n \
                    not in use if DB element\n"
        ...
        def getpin(self,pin):# make private
      ...
      def statout(self):
            ...
            for ad in self.Blocks.keys():
                  ...
                  if NAME not in blocks:
                        blocks+=(NAME,)
                        out+=((NAME,self.CountBlocks(NAME),self.AveragePins(NAME)),)
            return out
